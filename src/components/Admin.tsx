...
const Admin = () => {
  const { user } = useAuth();
  const [activeView, setActiveView] = useState<'users' | 'events'>('users')
    ...
    <div className="space-y-6 pb-20">
        ...
        <div>
          ...
          <div className="mt-2 inline-flex rounded-lg border border-gray-200 overflow-hidden">
            <button
              ...
              className={`px-4 py-2 text-sm ${activeView === 'users' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'}`}
            >
              Users
            </button>
            <button
              onClick={() => setActiveView('events')}
              className={`px-4 py-2 text-sm ${activeView === 'events' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'}`}
            >
              Events
            </button>
          </div>
      ...
      {activeView === 'events' ? (
        ...
        <>
          ...
          {/* Success/Error Messages and Users Table (existing content) */}
